...
Person.create("type"=>"Teacher","user_name"=>"LarryTeacher", "password_digest"=>"123", "first_name"=>"Larry", "last_name"=>"Teacher", "email"=>"larry@email.com")
Person.create("type"=>"Teacher","user_name"=>"MoeTeacher", "password_digest"=>"123", "first_name"=>"Moe", "last_name"=>"Teacher", "email"=>"moe@email.com")
Person.create("type"=>"Teacher","user_name"=>"CurleyTeacher", "password_digest"=>"123", "first_name"=>"Curley", "last_name"=>"Teacher", "email"=>"curley@email.com")
Person.create("type"=>"Student","user_name"=>"JimmyStudent", "password_digest"=>"123", "first_name"=>"Jimmy", "last_name"=>"Student", "email"=>"jimmy@email.com")
Person.create("type"=>"Student","user_name"=>"BillyStudent", "password_digest"=>"IOU", "first_name"=>"Billy", "last_name"=>"Student", "email"=>"billy@email.com")
Person.create("type"=>"Student","user_name"=>"KeatonStudent", "password_digest"=>"LKJ", "first_name"=>"Keaton", "last_name"=>"Student", "email"=>"keaton@email.com")
